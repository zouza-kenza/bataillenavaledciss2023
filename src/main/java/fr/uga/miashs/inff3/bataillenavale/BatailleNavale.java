...
public class BatailleNavale {
	...
	private void initialize() {
		...
		buttonGroup2.add(btnJ2Graphique);
		btnJ2Graphique.setSelected(true);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				else if (btnJ1Auto.isSelected()) {
					GrilleNavale gn1 = new GrilleNavale(taille,tailleNavires);
					joueur1 = new JoueurAuto(gn1,tfNomJ1.getText());
				...
				if (btnJ2Graphique.isSelected()) {
					...
					gn2.placementAuto(tailleNavires);
					joueur2 = new JoueurGraphique(gn2,gt2,tfNomJ2.getText());
					
					f2.setVisible(true);
				}
				else if (btnJ2Texte.isSelected()) {
					GrilleNavale gn2 = new GrilleNavale(taille, tailleNavires);
					joueur2 = new JoueurTexte(gn2,tfNomJ2.getText());
					//f2.setVisible(true);
				}
				else if (btnJ2Auto.isSelected()) {
					GrilleNavale gn2 = new GrilleNavale(taille,tailleNavires);
		...
		btnNewButton.setBounds(98, 0, 107, 23);
